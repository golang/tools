...
require (
	...
	golang.org/x/tools/godoc v0.0.0 // a requirement on an already released version wouldn't build because of ambiguous import errors
)
...
replace (
	golang.org/x/tools => ../../
	golang.org/x/tools/godoc => ../../godoc
)
