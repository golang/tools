...
In vim and neovim, it's very easy to enable gopls in [vim-easycomplete](https://github.com/jayli/vim-easycomplete) via `:InstallLspServer go` and config nothing.
